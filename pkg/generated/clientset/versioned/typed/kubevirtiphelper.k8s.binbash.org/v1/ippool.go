...
type IPPoolInterface interface {
	...
	Apply(ctx context.Context, iPPool *kubevirtiphelperk8sbinbashorgv1.IPPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IPPool, err error)
	ApplyStatus(ctx context.Context, iPPool *kubevirtiphelperk8sbinbashorgv1.IPPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IPPool, err error)
	IPPoolExpansion
}
...
func newIPPools(c *KubevirtiphelperV1Client) *iPPools {
	return &iPPools{
		client: c.RESTClient(),
	}
}
...
func (c *iPPools) Apply(ctx context.Context, iPPool *kubevirtiphelperk8sbinbashorgv1.IPPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IPPool, err error) {
	if iPPool == nil {
...
func (c *iPPools) ApplyStatus(ctx context.Context, iPPool *kubevirtiphelperk8sbinbashorgv1.IPPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IPPool, err error) {
	if iPPool == nil {
		return nil, fmt.Errorf("iPPool provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
