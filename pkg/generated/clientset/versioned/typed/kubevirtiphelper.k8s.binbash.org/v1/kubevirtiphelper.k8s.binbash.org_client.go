...
import (
	...
	"github.com/joeyloman/kubevirt-ip-helper/pkg/generated/clientset/versioned/scheme"
...
// NewForConfigAndClient creates a new KubevirtiphelperV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*KubevirtiphelperV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &KubevirtiphelperV1Client{client}, nil
}

// NewForConfigOrDie creates a new KubevirtiphelperV1Client for the given config and
...
func New(c rest.Interface) *KubevirtiphelperV1Client {
	return &KubevirtiphelperV1Client{c}
}
