...
import (
	v1 "github.com/joeyloman/kubevirt-ip-helper/pkg/generated/clientset/versioned/typed/kubevirtiphelper.k8s.binbash.org/v1"
...
func (c *FakeKubevirtiphelperV1) IPPools() v1.IPPoolInterface {
