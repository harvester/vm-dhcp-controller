...
func (c *FakeIPPools) Apply(ctx context.Context, iPPool *kubevirtiphelperk8sbinbashorgv1.IPPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IPPool, err error) {
	if iPPool == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(ippoolsResource, *name, types.ApplyPatchType, data), &v1.IPPool{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.IPPool), err
...
func (c *FakeIPPools) ApplyStatus(ctx context.Context, iPPool *kubevirtiphelperk8sbinbashorgv1.IPPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.IPPool, err error) {
	if iPPool == nil {
		return nil, fmt.Errorf("iPPool provided to Apply must not be nil")
	}
	data, err := json.Marshal(iPPool)
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(ippoolsResource, *name, types.ApplyPatchType, data, "status"), &v1.IPPool{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.IPPool), err
