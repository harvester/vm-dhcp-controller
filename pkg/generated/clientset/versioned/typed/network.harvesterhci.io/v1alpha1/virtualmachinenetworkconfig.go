...
func (c *virtualMachineNetworkConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VirtualMachineNetworkConfig, err error) {
...
func (c *virtualMachineNetworkConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VirtualMachineNetworkConfigList, err error) {
...
func (c *virtualMachineNetworkConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualMachineNetworkConfigs) Create(ctx context.Context, virtualMachineNetworkConfig *v1alpha1.VirtualMachineNetworkConfig, opts v1.CreateOptions) (result *v1alpha1.VirtualMachineNetworkConfig, err error) {
	result = &v1alpha1.VirtualMachineNetworkConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualmachinenetworkconfigs").
...
func (c *virtualMachineNetworkConfigs) Update(ctx context.Context, virtualMachineNetworkConfig *v1alpha1.VirtualMachineNetworkConfig, opts v1.UpdateOptions) (result *v1alpha1.VirtualMachineNetworkConfig, err error) {
	result = &v1alpha1.VirtualMachineNetworkConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachinenetworkconfigs").
...
func (c *virtualMachineNetworkConfigs) UpdateStatus(ctx context.Context, virtualMachineNetworkConfig *v1alpha1.VirtualMachineNetworkConfig, opts v1.UpdateOptions) (result *v1alpha1.VirtualMachineNetworkConfig, err error) {
	result = &v1alpha1.VirtualMachineNetworkConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachinenetworkconfigs").
...
func (c *virtualMachineNetworkConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *virtualMachineNetworkConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *virtualMachineNetworkConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualMachineNetworkConfig, err error) {
	result = &v1alpha1.VirtualMachineNetworkConfig{}
