...
// NetworkV1alpha1Client is used to interact with features provided by the network.harvesterhci.io group.
...
func setConfigDefaults(config *rest.Config) {
	gv := networkharvesterhciiov1alpha1.SchemeGroupVersion
